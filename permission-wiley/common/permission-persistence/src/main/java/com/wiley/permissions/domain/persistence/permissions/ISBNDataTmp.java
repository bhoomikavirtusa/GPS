...
@Table(name = "isbn_data_tmp")
public class ISBNDataTmp
extends DomainObject
{
	...
	public ISBNDataTmp(String isbn13, Integer grossUnits) {
		this.isbn13 = isbn13;
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof ISBNDataTmp)) return false;
		ISBNDataTmp other = (ISBNDataTmp) obj;
		if (isbn13 == null) {
