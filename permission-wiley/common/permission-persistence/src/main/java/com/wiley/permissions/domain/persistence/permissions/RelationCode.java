...
extends DomainObject
{
	...
	public static RelationCode WC = new RelationCode("WC", "Wiley / Custom");
	public static RelationCode CW = new RelationCode("CW", "Custom / Wiley");
	...
	public RelationCode(String code, String name) {
		this.code = code;
		this.name = name;
	}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof RelationCode)) return false;
		RelationCode other = (RelationCode) obj;
		if (code == null) {
